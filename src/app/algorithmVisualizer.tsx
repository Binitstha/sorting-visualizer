...
const AlgorithVisualizer = () => {
  ...
  return (
    ...
    <div className="border h-full rounded-md bottom-10 flex justify-center px-3 items-end gap-2" id="contentContainer">
    ...
    <div className="flex gap-5 relative justify-center items-center">
      ...
      <div className="w-fit absolute right-4">
        <div className={clsx(isSorting ? "opacity-60 cursor-not-allowed" : "opacity-100", "flex gap-2 justify-center items-center w-36")}>
